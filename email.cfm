...
<cfset aCC = "testCC@gmail.com" />
    ...
    <script>
        ...
        function newEmail(name,subject,bcc,cc) {
            ...
            window.location.href='mailto:sd19surf@gmail.com&cc='+cc+'&bcc='+bcc+'&subject='+subject+'&body='+ mess;
...
<cfoutput>
<body onload="newEmail('#aName#','#aSubject#','#aBCC#','#aCC#');">
    </cfoutput>
